...
import { QueryOptions, GameRecord, SpiderSource } from '../types';
...
// 查询保存的游戏数据
export async function queryGames(db: Database, options: QueryOptions = {}): Promise<GameRecord[]> {
...
// 获取可用的榜单日期列表
export async function getRankDates(db: Database, options: { source?: SpiderSource, rankType?: string } = {}): Promise<string[]> {
